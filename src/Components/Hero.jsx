        ...
        <>
          <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
             <div className='flex flex-row items-center py-[6px] px-4px bg-discount-gradient rounded-10 mb-2'> 
             ...
             Discount for {" "} <span className='text-white'>1 Month</span>Account
              ...
              <h1 className='flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]'>
               ...
               <div className='ss:flex hidden ms:mr-4 mr-0'>
               <GetStarted />
            ...
            <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
              ...
              <div className='absolute z-[1] w-[80%] h-[80%] top-0 rounded-full bottom-40 white__gradient' />
              <div className='absolute z-[0] w-[50%] h-[55%]  right-20 bottom-20 top-0 blue__gradient' />
            </div>
